...
ActiveRecord::Schema.define(:version => 20120402132558) do
  ...
  create_view "current_pulldown_multiplexed_library_tubes", "select `pulldown_multiplexed_library_tubes`.`dont_use_id` AS `dont_use_id`,`pulldown_multiplexed_library_tubes`.`uuid` AS `uuid`,`pulldown_multiplexed_library_tubes`.`internal_id` AS `internal_id`,`pulldown_multiplexed_library_tubes`.`name` AS `name`,`pulldown_multiplexed_library_tubes`.`barcode` AS `barcode`,`pulldown_multiplexed_library_tubes`.`barcode_prefix` AS `barcode_prefix`,`pulldown_multiplexed_library_tubes`.`state` AS `state`,`pulldown_multiplexed_library_tubes`.`closed` AS `closed`,`pulldown_multiplexed_library_tubes`.`concentration` AS `concentration`,`pulldown_multiplexed_library_tubes`.`volume` AS `volume`,`pulldown_multiplexed_library_tubes`.`two_dimensional_barcode` AS `two_dimensional_barcode`,`pulldown_multiplexed_library_tubes`.`scanned_in_date` AS `scanned_in_date`,`pulldown_multiplexed_library_tubes`.`is_current` AS `is_current`,`pulldown_multiplexed_library_tubes`.`checked_at` AS `checked_at`,`pulldown_multiplexed_library_tubes`.`last_updated` AS `last_updated`,`pulldown_multiplexed_library_tubes`.`created` AS `created`,`pulldown_multiplexed_library_tubes`.`public_name` AS `public_name`,`pulldown_multiplexed_library_tubes`.`inserted_at` AS `inserted_at`,`pulldown_multiplexed_library_tubes`.`deleted_at` AS `deleted_at`,`pulldown_multiplexed_library_tubes`.`current_from` AS `current_from`,`pulldown_multiplexed_library_tubes`.`current_to` AS `current_to` from `pulldown_multiplexed_library_tubes` where isnull(`pulldown_multiplexed_library_tubes`.`current_to`)", :force => true do |v|
    v.column :dont_use_id
    v.column :uuid
    v.column :internal_id
    v.column :name
  ...
  create_view "uuid_objects", "(select `aliquots`.`uuid` AS `uuid`,hex(`aliquots`.`uuid`) AS `decoded_uuid`,`aliquots`.`checked_at` AS `checked_at`,`aliquots`.`last_updated` AS `last_updated`,`aliquots`.`created` AS `created`,`aliquots`.`deleted_at` AS `deleted_at`,NULL AS `name`,`aliquots`.`internal_id` AS `internal_id`,'aliquots' AS `object_name` from `aliquots` where (isnull(`aliquots`.`current_to`) and (`aliquots`.`uuid` is not null))) union (select `asset_audits`.`uuid` AS `uuid`,hex(`asset_audits`.`uuid`) AS `decoded_uuid`,`asset_audits`.`checked_at` AS `checked_at`,`asset_audits`.`last_updated` AS `last_updated`,`asset_audits`.`created` AS `created`,`asset_audits`.`deleted_at` AS `deleted_at`,NULL AS `name`,`asset_audits`.`internal_id` AS `internal_id`,'asset_audits' AS `object_name` from `asset_audits` where (isnull(`asset_audits`.`current_to`) and (`asset_audits`.`uuid` is not null))) union (select `asset_links`.`uuid` AS `uuid`,hex(`asset_links`.`uuid`) AS `decoded_uuid`,`asset_links`.`checked_at` AS `checked_at`,`asset_links`.`last_updated` AS `last_updated`,`asset_links`.`created` AS `created`,`asset_links`.`deleted_at` AS `deleted_at`,NULL AS `name`,NULL AS `internal_id`,'asset_links' AS `object_name` from `asset_links` where (isnull(`asset_links`.`current_to`) and (`asset_links`.`uuid` is not null))) union (select `batch_requests`.`uuid` AS `uuid`,hex(`batch_requests`.`uuid`) AS `decoded_uuid`,`batch_requests`.`checked_at` AS `checked_at`,`batch_requests`.`last_updated` AS `last_updated`,`batch_requests`.`created` AS `created`,`batch_requests`.`deleted_at` AS `deleted_at`,NULL AS `name`,`batch_requests`.`internal_id` AS `internal_id`,'batch_requests' AS `object_name` from `batch_requests` where (isnull(`batch_requests`.`current_to`) and (`batch_requests`.`uuid` is not null))) union (select `batches`.`uuid` AS `uuid`,hex(`batches`.`uuid`) AS `decoded_uuid`,`batches`.`checked_at` AS `checked_at`,`batches`.`last_updated` AS `last_updated`,`batches`.`created` AS `created`,`batches`.`deleted_at` AS `deleted_at`,NULL AS `name`,`batches`.`internal_id` AS `internal_id`,'batches' AS `object_name` from `batches` where (isnull(`batches`.`current_to`) and (`batches`.`uuid` is not null))) union (select `billing_events`.`uuid` AS `uuid`,hex(`billing_events`.`uuid`) AS `decoded_uuid`,`billing_events`.`checked_at` AS `checked_at`,`billing_events`.`last_updated` AS `last_updated`,`billing_events`.`created` AS `created`,`billing_events`.`deleted_at` AS `deleted_at`,NULL AS `name`,`billing_events`.`internal_id` AS `internal_id`,'billing_events' AS `object_name` from `billing_events` where (isnull(`billing_events`.`current_to`) and (`billing_events`.`uuid` is not null))) union (select `events`.`uuid` AS `uuid`,hex(`events`.`uuid`) AS `decoded_uuid`,`events`.`checked_at` AS `checked_at`,`events`.`last_updated` AS `last_updated`,`events`.`created` AS `created`,`events`.`deleted_at` AS `deleted_at`,NULL AS `name`,`events`.`internal_id` AS `internal_id`,'events' AS `object_name` from `events` where (isnull(`events`.`current_to`) and (`events`.`uuid` is not null))) union (select `lanes`.`uuid` AS `uuid`,hex(`lanes`.`uuid`) AS `decoded_uuid`,`lanes`.`checked_at` AS `checked_at`,`lanes`.`last_updated` AS `last_updated`,`lanes`.`created` AS `created`,`lanes`.`deleted_at` AS `deleted_at`,`lanes`.`name` AS `name`,`lanes`.`internal_id` AS `internal_id`,'lanes' AS `object_name` from `lanes` where (isnull(`lanes`.`current_to`) and (`lanes`.`uuid` is not null))) union (select `library_tubes`.`uuid` AS `uuid`,hex(`library_tubes`.`uuid`) AS `decoded_uuid`,`library_tubes`.`checked_at` AS `checked_at`,`library_tubes`.`last_updated` AS `last_updated`,`library_tubes`.`created` AS `created`,`library_tubes`.`deleted_at` AS `deleted_at`,`library_tubes`.`name` AS `name`,`library_tubes`.`internal_id` AS `internal_id`,'library_tubes' AS `object_name` from `library_tubes` where (isnull(`library_tubes`.`current_to`) and (`library_tubes`.`uuid` is not null))) union (select `multiplexed_library_tubes`.`uuid` AS `uuid`,hex(`multiplexed_library_tubes`.`uuid`) AS `decoded_uuid`,`multiplexed_library_tubes`.`checked_at` AS `checked_at`,`multiplexed_library_tubes`.`last_updated` AS `last_updated`,`multiplexed_library_tubes`.`created` AS `created`,`multiplexed_library_tubes`.`deleted_at` AS `deleted_at`,`multiplexed_library_tubes`.`name` AS `name`,`multiplexed_library_tubes`.`internal_id` AS `internal_id`,'multiplexed_library_tubes' AS `object_name` from `multiplexed_library_tubes` where (isnull(`multiplexed_library_tubes`.`current_to`) and (`multiplexed_library_tubes`.`uuid` is not null))) union (select `orders`.`uuid` AS `uuid`,hex(`orders`.`uuid`) AS `decoded_uuid`,`orders`.`checked_at` AS `checked_at`,`orders`.`last_updated` AS `last_updated`,`orders`.`created` AS `created`,`orders`.`deleted_at` AS `deleted_at`,NULL AS `name`,`orders`.`internal_id` AS `internal_id`,'orders' AS `object_name` from `orders` where (isnull(`orders`.`current_to`) and (`orders`.`uuid` is not null))) union (select `plate_purposes`.`uuid` AS `uuid`,hex(`plate_purposes`.`uuid`) AS `decoded_uuid`,`plate_purposes`.`checked_at` AS `checked_at`,`plate_purposes`.`last_updated` AS `last_updated`,`plate_purposes`.`created` AS `created`,`plate_purposes`.`deleted_at` AS `deleted_at`,`plate_purposes`.`name` AS `name`,`plate_purposes`.`internal_id` AS `internal_id`,'plate_purposes' AS `object_name` from `plate_purposes` where (isnull(`plate_purposes`.`current_to`) and (`plate_purposes`.`uuid` is not null))) union (select `plates`.`uuid` AS `uuid`,hex(`plates`.`uuid`) AS `decoded_uuid`,`plates`.`checked_at` AS `checked_at`,`plates`.`last_updated` AS `last_updated`,`plates`.`created` AS `created`,`plates`.`deleted_at` AS `deleted_at`,`plates`.`name` AS `name`,`plates`.`internal_id` AS `internal_id`,'plates' AS `object_name` from `plates` where (isnull(`plates`.`current_to`) and (`plates`.`uuid` is not null))) union (select `projects`.`uuid` AS `uuid`,hex(`projects`.`uuid`) AS `decoded_uuid`,`projects`.`checked_at` AS `checked_at`,`projects`.`last_updated` AS `last_updated`,`projects`.`created` AS `created`,`projects`.`deleted_at` AS `deleted_at`,`projects`.`name` AS `name`,`projects`.`internal_id` AS `internal_id`,'projects' AS `object_name` from `projects` where (isnull(`projects`.`current_to`) and (`projects`.`uuid` is not null))) union (select `pulldown_multiplexed_library_tubes`.`uuid` AS `uuid`,hex(`pulldown_multiplexed_library_tubes`.`uuid`) AS `decoded_uuid`,`pulldown_multiplexed_library_tubes`.`checked_at` AS `checked_at`,`pulldown_multiplexed_library_tubes`.`last_updated` AS `last_updated`,`pulldown_multiplexed_library_tubes`.`created` AS `created`,`pulldown_multiplexed_library_tubes`.`deleted_at` AS `deleted_at`,`pulldown_multiplexed_library_tubes`.`name` AS `name`,`pulldown_multiplexed_library_tubes`.`internal_id` AS `internal_id`,'pulldown_multiplexed_library_tubes' AS `object_name` from `pulldown_multiplexed_library_tubes` where (isnull(`pulldown_multiplexed_library_tubes`.`current_to`) and (`pulldown_multiplexed_library_tubes`.`uuid` is not null))) union (select `quotas`.`uuid` AS `uuid`,hex(`quotas`.`uuid`) AS `decoded_uuid`,`quotas`.`checked_at` AS `checked_at`,`quotas`.`last_updated` AS `last_updated`,`quotas`.`created` AS `created`,`quotas`.`deleted_at` AS `deleted_at`,NULL AS `name`,`quotas`.`internal_id` AS `internal_id`,'quotas' AS `object_name` from `quotas` where (isnull(`quotas`.`current_to`) and (`quotas`.`uuid` is not null))) union (select `requests`.`uuid` AS `uuid`,hex(`requests`.`uuid`) AS `decoded_uuid`,`requests`.`checked_at` AS `checked_at`,`requests`.`last_updated` AS `last_updated`,`requests`.`created` AS `created`,`requests`.`deleted_at` AS `deleted_at`,NULL AS `name`,`requests`.`internal_id` AS `internal_id`,'requests' AS `object_name` from `requests` where (isnull(`requests`.`current_to`) and (`requests`.`uuid` is not null))) union (select `sample_tubes`.`uuid` AS `uuid`,hex(`sample_tubes`.`uuid`) AS `decoded_uuid`,`sample_tubes`.`checked_at` AS `checked_at`,`sample_tubes`.`last_updated` AS `last_updated`,`sample_tubes`.`created` AS `created`,`sample_tubes`.`deleted_at` AS `deleted_at`,`sample_tubes`.`name` AS `name`,`sample_tubes`.`internal_id` AS `internal_id`,'sample_tubes' AS `object_name` from `sample_tubes` where (isnull(`sample_tubes`.`current_to`) and (`sample_tubes`.`uuid` is not null))) union (select `samples`.`uuid` AS `uuid`,hex(`samples`.`uuid`) AS `decoded_uuid`,`samples`.`checked_at` AS `checked_at`,`samples`.`last_updated` AS `last_updated`,`samples`.`created` AS `created`,`samples`.`deleted_at` AS `deleted_at`,`samples`.`name` AS `name`,`samples`.`internal_id` AS `internal_id`,'samples' AS `object_name` from `samples` where (isnull(`samples`.`current_to`) and (`samples`.`uuid` is not null))) union (select `studies`.`uuid` AS `uuid`,hex(`studies`.`uuid`) AS `decoded_uuid`,`studies`.`checked_at` AS `checked_at`,`studies`.`last_updated` AS `last_updated`,`studies`.`created` AS `created`,`studies`.`deleted_at` AS `deleted_at`,`studies`.`name` AS `name`,`studies`.`internal_id` AS `internal_id`,'studies' AS `object_name` from `studies` where (isnull(`studies`.`current_to`) and (`studies`.`uuid` is not null))) union (select `study_samples`.`uuid` AS `uuid`,hex(`study_samples`.`uuid`) AS `decoded_uuid`,`study_samples`.`checked_at` AS `checked_at`,`study_samples`.`last_updated` AS `last_updated`,`study_samples`.`created` AS `created`,`study_samples`.`deleted_at` AS `deleted_at`,NULL AS `name`,`study_samples`.`internal_id` AS `internal_id`,'study_samples' AS `object_name` from `study_samples` where (isnull(`study_samples`.`current_to`) and (`study_samples`.`uuid` is not null))) union (select `submissions`.`uuid` AS `uuid`,hex(`submissions`.`uuid`) AS `decoded_uuid`,`submissions`.`checked_at` AS `checked_at`,`submissions`.`last_updated` AS `last_updated`,`submissions`.`created` AS `created`,`submissions`.`deleted_at` AS `deleted_at`,NULL AS `name`,`submissions`.`internal_id` AS `internal_id`,'submissions' AS `object_name` from `submissions` where (isnull(`submissions`.`current_to`) and (`submissions`.`uuid` is not null))) union (select `tags`.`uuid` AS `uuid`,hex(`tags`.`uuid`) AS `decoded_uuid`,`tags`.`checked_at` AS `checked_at`,`tags`.`last_updated` AS `last_updated`,`tags`.`created` AS `created`,`tags`.`deleted_at` AS `deleted_at`,NULL AS `name`,`tags`.`internal_id` AS `internal_id`,'tags' AS `object_name` from `tags` where (isnull(`tags`.`current_to`) and (`tags`.`uuid` is not null))) union (select `wells`.`uuid` AS `uuid`,hex(`wells`.`uuid`) AS `decoded_uuid`,`wells`.`checked_at` AS `checked_at`,`wells`.`last_updated` AS `last_updated`,`wells`.`created` AS `created`,`wells`.`deleted_at` AS `deleted_at`,`wells`.`name` AS `name`,`wells`.`internal_id` AS `internal_id`,'wells' AS `object_name` from `wells` where (isnull(`wells`.`current_to`) and (`wells`.`uuid` is not null)))", :force => true do |v|
    v.column :uuid

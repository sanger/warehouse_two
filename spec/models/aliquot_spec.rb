  ...
  let(:json) do
    {
      ...
      :bait_library_name                => 'bait library name',
      :bait_library_target_species      => 'bait library target species',
      :bait_library_supplier_identifier => 'bait library supplier identifier',
      :bait_library_supplier_name       => 'bait library supplier name'
    }
  end
end
